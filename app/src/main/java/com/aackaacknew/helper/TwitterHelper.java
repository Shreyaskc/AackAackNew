package com.aackaacknew.helper;
...
public class TwitterHelper {
    ...
    private static final String TWITTER_KEY = "os4y0Gvqf7oqjctzNwKl56acH";
    private static final String TWITTER_SECRET = "NwvW1BTAHUa91ACIMicoMBuqYjopHzNvF8kGpkwSkrfhTsehYO";
